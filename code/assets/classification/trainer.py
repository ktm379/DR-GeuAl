...
#             ex, he, ma, se = y_batch_train
            ...
            cls_loss = tf.keras.losses.SparseCategoricalCrossentropy(preds[0], y_batch_train[1])
            ...
            if not self.for_recons:
                ...
                return_loss = (cls_loss.numpy(), train_loss.numpy(), mask_loss.numpy())
                
            else:     
                train_loss = cls_loss 
                return_loss = (cls_loss.numpy(), train_loss.numpy())
