...
def combine_masks(mask_ex, mask_he, mask_ma, mask_se):
    ...
    # 색상별 마스크를 합치기
    combined_mask = np.clip(mask_ex_color + mask_he_color + mask_ma_color + mask_se_color, 0, 255)
    #combined_mask[combined_mask > 255] = 255  # 최대값을 255로 제한
    return combined_mask

def visualize_segmentation(image_CLAHE, image, mask_ex, mask_he, mask_ma, mask_se, mask_true, mask_pred, image_filename):
    ...
    masked_image = cv2.addWeighted(rgb_image, 1, resized_mask.astype(np.uint8), 1, 0)
...
def visualize_segmentation_results(image_filenames, model_path, mask_dir, image_dir, use_CLAHE):
    ...
    for image_filename in image_filenames:
        ...
        visualize_segmentation(image_CLAHE, image, selected_ex_mask, selected_he_mask, selected_ma_mask, selected_se_mask, None, preds[1], image_filename)
        print("============================================================================================================================")
